...
class ModelPlayground:
    ...
    def deploy(self, model_filepath, preprocessor_filepath, y_train, example_data=None, region=None, custom_libraries = "FALSE", image="aimodelshare_base_image:v3", reproducibility_env_filepath=None):
