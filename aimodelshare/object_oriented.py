...
class ModelPlayground:
    ...
    def quick_submit(self, model_filepath, preprocessor_filepath, prediction_submission, y_test, data_directory=None, eval_metric_filepath=None, email_list = [], public=True, public_private_split=0.5):
        """
