...
class ModelPlayground:
    ...
    def quick_submit(self, model_filepath, preprocessor_filepath, prediction_submission, data_directory, y_test, eval_metric_filepath=None, email_list = ["placeholder@email.com"], public=False, public_private_split=0.5):
        """
