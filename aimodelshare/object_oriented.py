...
class ModelPlayground:
    ...
    def create_competition(self, data_directory, y_test, eval_metric_filepath=None, email_list = [], public=True, public_private_split=0.5, input_dict=None):
        ...
        if "model_share"==os.environ.get("cloud_location"):
            ...
            compstring=self.class_string.replace(",aws=False","")+"."+"create_competition('/tmp/"+data_directory+"',"+'y_test'+","+onecheck(eval_metric_filepath)+","+'email_list'+",input_dict="+str(input_dict)+')'
            print(compstring)
            import base64
            import requests
            import json
