...
def deploy_container(account_id, region, session, project_name, model_dir, requirements_file_path, memory_size='1024', timeout='30', python_version='3.7',apiid):
    ...
    response = codebuild.create_project(
        ...
        artifacts={
            'type': 'S3',
            'location': codebuild_bucket_name + '/'  + apiid
        },
        environment={
