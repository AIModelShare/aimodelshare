...
def deploy_custom_lambda(lambda_filepath, deployment_dir, private, categorical=False, x_train=None, y_train=None, y_test=None, custom_libraries="FALSE"):
    ...
    user_client = boto3.client('apigateway',
