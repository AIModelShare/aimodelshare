...
def get_model_onnx(runtimemodel_s3_filename="runtime_model.onnx"):
    ...
    obj = s3.Object("aimodelsharethestreett517169013426", "3e99f5e2bef811eba2a680e6501b9bbe" +
                    "/runtime_model.onnx")
...
def get_preprocessor(preprocessor_s3_filename="runtime_preprocessor.zip"):
    ...
    import os
    s3 = boto3.resource("s3")
    bucket = s3.Bucket("aimodelsharethestreett517169013426")
    
    zip_obj = s3.Object(bucket_name="aimodelsharethestreett517169013426", key="3e99f5e2bef811eba2a680e6501b9bbe/runtime_preprocessor.zip")
...
def get_runtimedata(runtimedata_s3_filename="runtime_data.json"):
      ...
      s3 = boto3.resource('s3')
      obj = s3.Object("aimodelsharethestreett517169013426", "3e99f5e2bef811eba2a680e6501b9bbe"+"/"+runtimedata_s3_filename)
